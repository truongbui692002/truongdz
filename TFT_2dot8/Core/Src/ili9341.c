...
void Main_page(void)
{
    ...
    ILI9341_FillRectangle(20, 15, 280, 35, ILI9341_WHITE);

    HAL_Delay(50);

    ILI9341_DrawLine(160, 15, 160, 50, ILI9341_BLACK);

    ILI9341_WriteString(25, 25, "SimStatus:  ", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(165, 25, "Battery: 45%", Font_11x18,ILI9341_BLACK, ILI9341_WHITE);

    HAL_Delay(50);

    ILI9341_FillRectangle(38, 60, 244, 110, ILI9341_WHITE);
   ILI9341_DrawLine(160, 60, 160, 170, ILI9341_BLACK);
   ILI9341_DrawLine(38, 115, 282, 115, ILI9341_BLACK);

   ILI9341_WriteString(50, 65, "Nhip Tim", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(51, 90, "100 (BPM)", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);

    ILI9341_WriteString(177, 65, "So buoc:", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(161, 90, "10000(Buoc)", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);

    ILI9341_WriteString(50, 125, "Run Time", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(39, 150, "120 minutes", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);

    ILI9341_WriteString(161, 125, "Coordinates", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(165, 147, "Kinh do:    ", Font_7x10, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(165, 160, "Vi do:    ", Font_7x10, ILI9341_BLACK, ILI9341_WHITE);

    ILI9341_FillRectangle(65, 185, 190, 40, ILI9341_WHITE);
    ILI9341_WriteString(66, 197, "START", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(135, 197, "PAUSE", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_WriteString(205, 197, "STOP", Font_11x18, ILI9341_BLACK, ILI9341_WHITE);
    ILI9341_DrawLine(125, 185, 125, 225, ILI9341_BLACK);
    ILI9341_DrawLine(197, 185, 197, 225, ILI9341_BLACK);

    ILI9341_FillCircle(30, 205, 28, ILI9341_LIGHTBLUE);

    ILI9341_FillCircle(290, 205, 28, ILI9341_LIGHTBLUE);
    ILI9341_FillRectangle(275, 195, 25, 20, ILI9341_WHITE);
    ILI9341_FillTriangle(300, 190, 310, 205, 300, 220, ILI9341_WHITE);
    ILI9341_FillRectangle(20, 195, 25, 20, ILI9341_WHITE);
    ILI9341_FillTriangle(20, 190, 10, 205, 20, 220, ILI9341_WHITE);
